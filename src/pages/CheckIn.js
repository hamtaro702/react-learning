            ...
            <form onSubmit={addAccessInfo}>
              <div class="input-group mb-3">
                ...
                <input
                  ...
                  onChange={(event) =>
                    setPostData({ ...postData, surname: event.target.value })
                  }
                />
              </div>
              <div class="input-group mb-3">
                <input
                  ...
                  value={postData.idno}
                  onChange={(event) =>
                    setPostData({ ...postData, idno: event.target.value })
                  }
                />
                <span class="input-group-text"></span>
                <input
                  ...
                  name="tel"
                  required
                  value={postData.telno}
                  onChange={(event) =>
                    setPostData({ ...postData, telno: event.target.value })
                  }
                />
              </div>
              <div class="input-group mb-3">
                <input
                  ...
                  name="company"
                  required
                  value={postData.vendor}
                  onChange={(event) =>
                    setPostData({ ...postData, vendor: event.target.value })
                  }
                />
                <span class="input-group-text"></span>
                <input
              ...
              <textarea
                ...
                aria-label="เครื่องมือ/อุปกรณ์"
                name="accessory"
                required
                value={postData.accessory}
                onChange={(event) =>
                  setPostData({ ...postData, accessory: event.target.value })
                }
              />
              <br />
              <textarea
